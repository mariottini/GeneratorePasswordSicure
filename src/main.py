...
dictRepetion,sequenceCharDef = pwGenerator.pwPattern(password)
print(dictRepetion,sequenceCharDef)
print(pwGenerator.pwPatternPenalty(100,dictRepetion,sequenceCharDef))
